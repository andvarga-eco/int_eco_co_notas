...
ggplot(xagglong,aes(x=factor(year),y=value,fill=Sector))+geom_bar(position="fill",stat="identity")+ylab("Porcentaje")+
...
ggplot(magglong,aes(x=factor(year),y=value,fill=Sector))+geom_bar(position="fill",stat="identity")+ylab("Porcentaje")+
xlab("Año")+scale_x_discrete(breaks=c("1980","1985","1990","1995","2000","2005","2010","2015","2019"))
